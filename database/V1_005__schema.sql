...
INSERT INTO `localization` VALUES (1,1,1,'en_EN','English'),(2,1,1,'fi_FI','Finnish'),(3,1,1,'sv_SV','Swedish'),(4,1,1,'fr_FR','French'),(20,2,1,'en_EN','English');
...
CREATE TABLE `localize` (
  ...
  CONSTRAINT `localize_ibfk_2` FOREIGN KEY (`organizationId`) REFERENCES `organization` (`id`)
...
INSERT INTO `localize` VALUES (8,1,1,'welcome',0,0),(9,1,1,'good',0,0),(10,1,1,'city',0,0),(13,5,2,'shop',0,0),(14,5,2,'student',0,0),(15,1,2,'student',0,0),(16,1,2,'Road',0,0);
...
INSERT INTO `localizedValue` VALUES (2,1,8,'Welcome'),(3,2,8,'TerveTuloa'),(4,2,9,'Hyvää'),(5,1,9,'Good'),(6,2,14,'Opiskele');
...
-- Dump completed on 2020-05-20 14:01:19
